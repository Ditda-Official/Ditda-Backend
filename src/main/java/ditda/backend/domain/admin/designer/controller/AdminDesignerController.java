...
public class AdminDesignerController {
	...
	public ApiResponse<DesignerAccountResponse> getDesignerAccount(
		...
		DesignerAccountResponse response = adminDesignerService.getDesignerAccount(designerId);
	...
	public ApiResponse<DesignerPortfolioResponse> getDesignerPortfolios(
		...
		DesignerPortfolioResponse response = adminDesignerService.getDesignerPortfolios(designerId);
