...
import ditda.backend.domain.designer.auth.entity.enums.BankName;
...
@Schema(description = "디자이너 회원가입 요청")
public record DesignerSignupRequest(
	...
	public record BankAccountRequest(
		...
		@Pattern(regexp = "^[0-9]{10,15}$", message = "올바른 계좌번호 형식이 아닙니다. (숫자 10~15자리)")
