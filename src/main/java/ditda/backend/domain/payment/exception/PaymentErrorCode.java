...
public enum PaymentErrorCode implements BaseErrorCode {
	...
	// 환불
	REFUND_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "PAYMENT_400_02", "환불 가능한 결제 상태가 아닙니다."),
	INVALID_REFUND_AMOUNT(HttpStatus.BAD_REQUEST, "PAYMENT_400_03", "환불 금액이 원래 결제 금액을 초과할 수 없습니다.");
