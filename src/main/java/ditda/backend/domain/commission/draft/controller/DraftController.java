...
import ditda.backend.domain.commission.draft.facade.DraftFacade;
...
public class DraftController {
	...
	public ApiResponse<DraftListResponse> getFirstRoundDrafts(
		...
		DraftListResponse response = draftFacade.getFirstRoundDrafts(instructorId, commissionId);
	...
	public ApiResponse<DraftDetailResponse> getDraftDetail(
		...
		DraftDetailResponse response = draftFacade.getDraftDetail(instructorId, commissionId, draftId);
	...
	public ApiResponse<DraftSelectResponse> selectDraft(
		...
		DraftSelectResponse response = draftFacade.selectDraft(instructorId, commissionId, draftId);
